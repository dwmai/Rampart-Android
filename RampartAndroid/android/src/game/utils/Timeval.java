...
/**
 * POSIX.4 timeval for Java. Container for java equivalent of c's struct timeval.
 *
 ...
 */
public class Timeval implements Serializable, Comparable<Timeval> {

	long seconds;
	long microseconds;
	private String _rcsid = "$Id: Timeval.java,v 1.2 2008/04/04 23:09:54 matthewe Exp $";

	public Timeval() {
		Date date = new Date();
		this.seconds = date.getTime() / 1000;
		this.microseconds = date.getTime() * 1000;
	}
